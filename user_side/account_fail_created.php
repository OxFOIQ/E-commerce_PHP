...
<!-- backgorud color noir -->
  ...
  <div class="container-fluid ">   
    <div class="row text">
          ...
          <div class="col-lg-5 col-sm-12 mt-5 text-center">
            <!-- empty space -->
             ...
             <h2 class="text-center text-break text-light mt-5"> We appologize .. <br> Something Went Wrong </h2>
             <a href="home.php" type="button" class="btn btn-floating btn-light btn-lg">Home <i class="fa fa-skull-crossbones"></i></a>
             <a href="verifsign.php" type="button" class="btn btn-floating btn-light btn-lg"> RETYPE <i class="fa fa-skull-crossbones"></i></a>
          </div>
    </div>
  </div>
